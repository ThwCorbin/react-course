...
var Student = function (_Person) {
  ...
  _createClass(Student, [{
    ...
    value: function hasMajor() {
      return !!this.major;
      // !! turns a string or undefined into a boolean
    }
  }, {
    key: "getDescription",
    value: function getDescription() {
      ...
      if (this.hasMajor()) {
        description += " " + firstName + "'s major is " + this.major + ".";
      } else {
        description += " " + firstName + " does not have major.";
      }
...
var newbie = new Student("John Apple", 27, "knitting");
console.log(newbie.hasMajor());
console.log(newbie.getDescription());

var newbie2 = new Student("Jen Peach", 21);
